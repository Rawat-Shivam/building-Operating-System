...
start:              ; start label from where our code starts
    ...
    start_os_intro db 'RawatOperatingSystem: R-OS!',0
    press_key db ' >> Press any key << ',0

    login_username db 'superuser : ',0
    login_password db 'passwd: ',0
    
    display_text db ' Minor Project ECE-2 4241012817 ROS', 0

    os_info db 10, 'ROS demo, 16-Bit, version=0.0.2',13,0

    press_key_2 db 10,'Press any key to move to graphics view',0

    window_text db 10,'Graphics in ROS-0.0.2', 0
    hello_world_text db 10,10, 'I started this in sep2018!',0
